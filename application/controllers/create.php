	...
	public function index($section) {
	    ...
	    */
	        ...
	        //$this->view($URI);
	            ...
	            $the_form = $impact_categories.'<input name="people_field" type="hidden" /><div class="dialog" name="people_dialog" id="people_dialog"></div><div class="dialog" id="unit_dialog">' . $menu_html . '</div>' . $this->form_extended->build();
