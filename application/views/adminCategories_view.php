...
<body id="home">
	<div id ="contentwrap">	
	<h1>Admin featured: add as textile</h1>
	<div id="columnwide">
				<?
					...
					foreach ($set as $row) {
						...
						echo '<div class="small blue square"><p><a href="/lca/addCategory?ft_id='.$myString.'&opencyc_id=Mx4rvVibU5wpEbGdrcN5Y29ycA" target="_blank">'.$row['label'].'</a><p/></div>';
					}
				?>
	</div>
	<?=$footerDisplay;?>
